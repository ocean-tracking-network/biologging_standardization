...
| [Instrument Settings File Attachment](fields/instrumentSettingsFileAttachment.md) | Attach a file with detailed instrument settings (eg. Wildlife Computers Report .htm file or screenshot of tag settings) |  | File (.htm, .pdf)|
...
| [Species](fields/species.md) | Binomial species epithet of organism carrying instrument | ITIS | String of the format “Genus species”, genus capitalized, separated by one space, eg. “Mirounga angustirostris”|
