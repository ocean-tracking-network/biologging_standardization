...
| [Organism weight at deployment](fields/organismWeight.md) | Weight of organism carrying instrument measured at tag deployment. |  | numerical in kg|
| [Organism weight re-measurement](fields/organismWeightRemeasurement.md) | Weight of organism carrying instrument at another time (specified in "Organism weight re-measurement time") than deployment.|  | numberical in kg|
